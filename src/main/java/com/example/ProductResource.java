...
public class ProductResource {
  ...
  public Iterable<Product> buscarProdutos(@RequestParam(required = false) final String raca) {
  ...
  public void alterarProduto(@PathVariable Long id, @RequestBody Product produtoParam) {
